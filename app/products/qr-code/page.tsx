...
export default function QRCodeGeneratorPage() {
  ...
  const benefits = [
    {
      icon: QrCode,
      title: "High-quality QR codes",
      description: "Generate crisp, scannable QR codes in multiple formats.",
    ...
    },
    {
      ...
      description: "Add colors, logos, and branding to your QR codes.",
    ...
    },
    {
      ...
      description: "Perfect scanning experience across all devices.",
    ...
    },
    {
      ...
      description: "Download as PNG, SVG, or high-res images.",
    ...
    },
    {
      icon: Eye,
      title: "Scan tracking",
      description: "Monitor QR code scans and engagement metrics.",
    ...
    },
    {
      ...
      description: "Fast generation with data privacy protection.",
  ...
  const steps = [
    {
      step: "01",
      title: "Enter content",
      description: "Add your URL, text, or contact info for QR generation.",
      icon: LinkIcon,
      uiCard: {
    ...
    },
    {
      ...
      description: "Add colors, logos, and perfect the QR code design.",
      icon: Palette,
      uiCard: {
        title: "Customize QR",
        content: "Add logo • Choose colors",
        action: "Save Design"
      }
    },
    {
      ...
      description: "Download in multiple formats and monitor scan analytics.",
      icon: Eye,
      uiCard: {
        title: "Analytics",
        content: "847 scans • 92% mobile",
        action: "View Stats"
      }
    }
  ]
  ...
  const faqs = [
    {
      ...
      answer: "A QR code generator creates scannable QR codes that can contain URLs, text, contact information, or other data. Biztro's QR generator creates high-quality, customizable QR codes with advanced features like branding, analytics, and multiple export formats."
    },
    {
      question: "What can I put in a QR code?",
      answer: "QR codes can contain URLs, plain text, contact information (vCard), WiFi credentials, calendar events, and more. Biztro supports all standard QR code data types for maximum versatility."
    },
    {
      question: "Can I customize my QR codes?",
      answer: "Absolutely! Customize colors, add your logo, choose different patterns, and adjust error correction levels. Make your QR codes match your brand identity and stand out from generic black-and-white codes."
    },
    {
      question: "Are Biztro QR codes scannable?",
      answer: "Yes! All QR codes generated by Biztro follow industry standards and are optimized for maximum scan reliability across all devices and QR code reader apps. We use the highest quality encoding for perfect scans every time."
    },
    {
      question: "Can I track who scans my QR codes?",
      answer: "Yes! Biztro provides comprehensive scan analytics including scan counts, geographic data, device types, timestamps, and conversion tracking. Monitor your QR code performance in real-time."
    },
    {
      question: "What formats can I download my QR codes in?",
      answer: "Download your QR codes as PNG, SVG, or high-resolution images. PNG is perfect for web use, SVG is ideal for scalable graphics, and high-res images work great for print materials."
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-[#fffbeb] relative overflow-hidden">
      ...
      {/* Navigation */}
      <Navigation currentPage="qr-code" />
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 xl:gap-24 items-center">
              ...
              >
                ...
                >
                  <QrCode className="w-4 h-4 text-[#282828]" />
                  <span className="text-sm font-medium text-[#282828]">Smart QR Codes</span>
                </motion.div>
                ...
                >
                  ...
                  <span className="block text-[#282828]/80">that drive results</span>
                  <span className="block text-[#282828]/60">in seconds</span>
                </motion.h1>
                ...
                >
                  Generate professional QR codes with custom branding, colors, and logos. Track scans, optimize performance, and engage your audience everywhere.
                </motion.p>
              ...
              {/* Right - QR Code Generation Preview */}
              <motion.div
                style={{ y: deviceY }}
                className="relative"
              >
                <div className="relative mx-auto max-w-sm lg:max-w-md xl:max-w-lg">
                  ...
                  >
                    ...
                    >
                      <div className="flex gap-3">
                        <input
                          ...
                          defaultValue="https://mybusiness.com/contact"
                        />
                        <motion.button
                    ...
                    >
                      {/* QR Code Display */}
                      <div className="bg-white rounded-2xl p-6 border border-gray-100/50 shadow-inner">
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex-1">
                            <div className="text-gray-600 text-xs mb-1">Generated QR Code</div>
                            <div className="text-gray-900 font-medium">Ready to download</div>
                          </div>
                          <motion.button
                            whileHover={{ scale: 1.1 }}
                            whileTap={{ scale: 0.9 }}
                            className="w-8 h-8 bg-[#282828]/10 hover:bg-[#282828]/20 rounded-lg flex items-center justify-center transition-all duration-200 ml-3"
                          >
                            <Download className="w-4 h-4 text-[#282828]" />
                          </motion.button>
                        </div>
                        {/* QR Code Placeholder */}
                        <div className="w-32 h-32 bg-gray-100 rounded-lg flex items-center justify-center mx-auto border-2 border-dashed border-gray-300">
                          <QrCode className="w-16 h-16 text-gray-400" />
                        </div>
                        <div className="text-center mt-3">
                          <div className="text-xs text-gray-500">PNG • SVG • High-res</div>
                        </div>
                      </div>
                      ...
                      >
                        <div className="bg-white/60 backdrop-blur-sm rounded-xl p-3 text-center">
                          <div className="text-lg font-bold text-[#282828]">847</div>
                          <div className="text-xs text-gray-600">Scans</div>
                        </div>
                        <div className="bg-white/60 backdrop-blur-sm rounded-xl p-3 text-center">
                          <div className="text-lg font-bold text-[#282828]">92%</div>
                          <div className="text-xs text-gray-600">Mobile</div>
                        </div>
                        <div className="bg-white/60 backdrop-blur-sm rounded-xl p-3 text-center">
                          <div className="text-lg font-bold text-[#282828]">12</div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 relative">
            ...
            >
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black text-[#282828] mb-6 leading-tight">
                Why Biztro QR codes are <span className="text-[#282828]/80">exceptional</span>
              </h2>
              <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto font-light leading-relaxed">
                Professional QR code generation with advanced customization, analytics, and branding features.
              </p>
            </motion.div>
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                  ...
                  >
                    <div className="text-center lg:text-left mb-8">
                      ...
                      <p className="text-gray-600">Create your QR code in seconds</p>
                    </div>

                    <div className="space-y-4">
                      {[
                        { step: 1, icon: LinkIcon, text: "Enter content", desc: "Add URL, text, or contact info" },
                        { step: 2, icon: Palette, text: "Customize design", desc: "Add colors, logos, and branding" },
                        { step: 3, icon: Eye, text: "Track analytics", desc: "Monitor scans and engagement" }
                      ].map((item, index) => {
        ...
        <section className="py-32 sm:py-40 lg:py-48 bg-gradient-to-br from-[#282828] via-[#282828]/95 to-[#1a1a1a] relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 relative">
            ...
            >
              ...
              >
                Ready to create QR codes the
                <span className="block text-white/90">professional way?</span>
              </motion.h2>
              ...
              >
                Join thousands of businesses who trust Biztro to create stunning, trackable QR codes.
              </motion.p>
